import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as r,d as a}from"./app-NWC4HiYT.js";const i={},t=a(`<h1 id="基于标签的告警路由" tabindex="-1"><a class="header-anchor" href="#基于标签的告警路由" aria-hidden="true">#</a> 基于标签的告警路由</h1><p>在Alertmanager的配置中会定义一个基于标签匹配规则的告警路由树，以确定在接收到告警后Alertmanager需要如何对其进行处理：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>route: &lt;route&gt;
