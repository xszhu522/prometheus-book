import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,d as s}from"./app-NWC4HiYT.js";const a={},r=s(`<h1 id="内置告警接收器receiver" tabindex="-1"><a class="header-anchor" href="#内置告警接收器receiver" aria-hidden="true">#</a> 内置告警接收器Receiver</h1><p>前上一小节已经讲过，在Alertmanager中路由负责对告警信息进行分组匹配，并将像告警接收器发送通知。告警接收器可以通过以下形式进行配置：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>receivers:
  - &lt;receiver&gt; ...
