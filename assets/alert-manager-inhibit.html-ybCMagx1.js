import{_ as e,a,b as i}from"./alertmanager-slicense-alerts-result-r8aeiGp2.js";import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as t,c as r,d as l}from"./app-NWC4HiYT.js";const d={},s=l(`<h1 id="屏蔽告警通知" tabindex="-1"><a class="header-anchor" href="#屏蔽告警通知" aria-hidden="true">#</a> 屏蔽告警通知</h1><p>Alertmanager提供了方式可以帮助用户控制告警通知的行为，包括预先定义的抑制机制和临时定义的静默规则。</p><h2 id="抑制机制" tabindex="-1"><a class="header-anchor" href="#抑制机制" aria-hidden="true">#</a> 抑制机制</h2><p>Alertmanager的抑制机制可以避免当某种问题告警产生之后用户接收到大量由此问题导致的一系列的其它告警通知。例如当集群不可用时，用户可能只希望接收到一条告警，告诉他这时候集群出现了问题，而不是大量的如集群中的应用异常、中间件服务异常的告警通知。</p><p>在Alertmanager配置文件中，使用inhibit_rules定义一组告警的抑制规则：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>inhibit_rules:
  [ - &lt;inhibit_rule&gt; ... ]
