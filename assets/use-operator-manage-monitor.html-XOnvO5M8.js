import{_ as r}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as s,o as l,c as t,a as n,b as e,e as d,d as i}from"./app-NWC4HiYT.js";const m="/prometheus-book/assets/prometheus-rule-afi7Q3v9.png",u="/prometheus-book/assets/prometheus-alert-cluster-status-vJBNun2e.png",c={},o=i(`<h2 id="使用operator管理告警" tabindex="-1"><a class="header-anchor" href="#使用operator管理告警" aria-hidden="true">#</a> 使用Operator管理告警</h2><h3 id="使用prometheusrule定义告警规则" tabindex="-1"><a class="header-anchor" href="#使用prometheusrule定义告警规则" aria-hidden="true">#</a> 使用PrometheusRule定义告警规则</h3><p>对于Prometheus而言，在原生的管理方式上，我们需要手动创建Prometheus的告警文件，并且通过在Prometheus配置中声明式的加载。而在Prometheus Operator模式中，告警规则也编程一个通过Kubernetes API 声明式创建的一个资源，如下所示：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>apiVersion: monitoring.coreos.com/v1
kind: PrometheusRule
metadata:
  labels:
    prometheus: example
