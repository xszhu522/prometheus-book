import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as i,c as l,a as n,b as s,e as p,d as a}from"./app-d7bHIUBF.js";const c={},u=a(`<h1 id="在应用中内置prometheus支持" tabindex="-1"><a class="header-anchor" href="#在应用中内置prometheus支持" aria-hidden="true">#</a> 在应用中内置Prometheus支持</h1><p>本小节将以Spring Boot为例，介绍如何在应用代码中集成client_java。</p><p>添加Prometheus Java Client相关的依赖：</p><div class="language-groovy line-numbers-mode" data-ext="groovy"><pre class="language-groovy"><code>dependencies <span class="token punctuation">{</span>
